...
export default function KarmaScoreGauge({ score = 0 }) {
  // Karma score data
  const karmaScore = score || 0;
  const maxScore = 900;
  const percentage = (karmaScore / maxScore) * 100;
  
  // Color based on karma score
  ...
  const scoreColor = getColorByScore(karmaScore);
      ...
      <div className="relative" style={{ width: 240, height: 200 }}>
        ...
        <div className="absolute" style={{ top: '55%', left: '50%', transform: 'translate(-50%, -50%)' }}>
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg font-medium">{karmaScore}/900</p>
          </div>
        </div>
      </div>
    </div>
